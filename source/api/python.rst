...
The Python API is BSD licensed. It's now available in the pip package manager. `pip install quasardb` and you are good to go. You may also download it from the quasardb site or from GitHub at `<https://github.com/bureau14/qdb-api-python>`_.
