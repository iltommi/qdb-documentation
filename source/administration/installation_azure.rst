...
----------------
 ...
 #. Create a `Windows <https://docs.microsoft.com/en-us/azure/virtual-machines/windows/quick-create-portal>`_  virtual machine. Make sure your purchased and configured options meet the :ref:`sysreq-windows`.
...
--------------
 ...
 #. Create a `Linux <https://docs.microsoft.com/en-us/azure/virtual-machines/linux/quick-create-cli>`_  virtual machine. Make sure your purchased and configured options meet the :ref:`sysreq-linux`.
 #. Log in to your virtual machine.
